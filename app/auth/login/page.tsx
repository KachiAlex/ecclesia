    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 px-4 py-12">
      ...
      <div className="relative z-10 max-w-md w-full">
        ...
        {searchParams?.get('registered') === 'true' && (
          <div
            className={`mb-6 p-4 bg-green-50 border border-green-200 text-green-800 rounded-xl transition-all duration-500 ${
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to Ecclesia?</span>
              </div>
            </div>
