      ...
      <div className="p-6">
          ...
          <div className="space-y-6">
                ...
                {userResults.length > 0 && (
                  <div className="mt-4 space-y-2">
                    {userResults.map((user) => (
                      <div key={user.id} className="flex items-center justify-between gap-4 border border-gray-100 rounded-lg p-3">
                        <div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {members.map((member) => (
                  <div key={member.id} className="flex items-center justify-between gap-4 border border-gray-100 rounded-lg p-4">
        ...
        {activeTab === 'rules' && (
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-medium mb-4">Group Rules</h3>
              {canEditSettings && (
              ...
              <div className="space-y-2">
                {(settings.rules || []).map((rule, index) => (
                  <div key={index} className="flex items-start justify-between gap-4 border border-gray-100 rounded-lg p-3">
                    <div>
        ...
        {activeTab === 'invites' && (
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-medium mb-4">Invite Link</h3>
